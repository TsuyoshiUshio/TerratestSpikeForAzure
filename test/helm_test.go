...
func TestHelmBasicExampleDeployment(t *testing.T) {
	...
	kubectlOptions := k8s.NewKubectlOptions("", "../cluster_rbac/kubeconfig", namespaceName)
	...
	WaitUntilServiceExternalIPsAvailable(t, kubectlOptions, serviceName, 10, 20*time.Second)
